        ...
        try {
            ...
            if (isEditMode) {
                ...
                if (roomRes.data.success) {
                    ...
                    // Hàm chuẩn hóa tên địa chỉ để so sánh chính xác hơn
        ...
        <div className="container mx-auto max-w-2xl px-4 pt-4 mb-20">
            ...
            {success && (
                <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-2 rounded-lg mb-4 flex items-center gap-3 text-sm">
                    ...
                    <span className="font-medium">Cập nhật thành công! Đang chuyển hướng...</span>
                </div>
            )}
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl border border-gray-100 p-6">
                        <div className="flex items-start gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-lg font-extrabold text-gray-800">Đăng phòng thành công</h3>
                                <p className="text-sm text-gray-600 mt-1">Chờ quản trị viên duyệt bài đăng của bạn.</p>
                            </div>
                        </div>
                        <button
                            onClick={() => {
